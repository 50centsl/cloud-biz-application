...
@RestController
@RequestMapping("/api/cloud-biz-gateway-kafka")
public class CloudBizGatewayKafkaResource {

    private final Logger log = LoggerFactory.getLogger(CloudBizGatewayKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public CloudBizGatewayKafkaResource(KafkaProperties kafkaProperties) {
